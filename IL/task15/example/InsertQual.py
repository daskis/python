                ...
                <main class="container h-100">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            ...
                            <div class="alert alert-success" role="alert">
                                    Добавление в базу данных произведено успешно
                                </div>
                            </div>
                        </div>
                        </main>
...
try:
    ...
    cursorObj = con.cursor()
    cursorObj.execute("INSERT INTO Qualification (driving_exp, driving_in_company) VALUES (?, ?)", (Driving_Experience, Work_Experience))
    con.commit()
    showData(con)
    con.close()
    ...
    <body>
        <div class="alert alert-danger" role="alert">Произошла ошибка при добавлении записи: {str(e)}</div>
    </body>
    </html>'''
    print(error_message)